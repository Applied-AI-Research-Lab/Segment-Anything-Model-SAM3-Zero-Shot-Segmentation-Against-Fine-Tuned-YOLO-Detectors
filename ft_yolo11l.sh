#!/bin/bash
###############################################################################
# YOLO11-Large Fine-tuning Script
# 
# Trains YOLO11l-seg (large) model on MinneApple dataset.
# Fine-tuned models are saved to ft/yolo11l/{dataset}/
#
# Usage:
#   ./ft_yolo11l.sh minneapple     # Train on MinneApple
#   ./ft_yolo11l.sh weedsgalore    # Train on WeedsGalore
#
# Model: yolo11l-seg (large variant - best accuracy)
# Expected: ~80-100 MB model, F1 ≈ 65-70% (+12-16% over nano)
#
###############################################################################
...
clear
print_header "YOLO11-Large Fine-tuning Pipeline"
echo "Model: yolo11l-seg (large variant)"
...
###############################################################################
# Train YOLO11-Large Model
###############################################################################

print_header "Train YOLO11-Large Model"

EPOCHS=100
BATCH_SIZE=16
IMG_SIZE=640
MODEL_DIR="ft/yolo11l/${DATASET}"
MODEL_PATH="${MODEL_DIR}/best.pt"

print_info "Training Configuration:"
echo "  Model: yolo11l-seg (large)"
echo "  Epochs: $EPOCHS"
...
print_header "YOLO11-Large Training Complete!"
...
echo "  1. Run predictions: ./prediction_yolo11l.sh $DATASET"
echo "  2. Compare with nano and medium model results"
echo
