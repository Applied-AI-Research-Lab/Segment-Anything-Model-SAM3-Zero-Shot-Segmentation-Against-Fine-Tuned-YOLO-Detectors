#!/bin/bash
###############################################################################
# YOLO11-Large Prediction Script
# 
# Runs predictions using trained YOLO11l-seg (large) model.
#
# Usage:
#   ./prediction_yolo11l.sh minneapple
#   ./prediction_yolo11l.sh weedsgalore
#
# Model: yolo11l-seg (large variant)
# Expected: Best accuracy (~65-70% F1)
#
###############################################################################
...
clear
print_header "YOLO11-Large Prediction Pipeline"
...
OUTPUT_DIR="results/yolo11l_${DATASET}_${TIMESTAMP}"
